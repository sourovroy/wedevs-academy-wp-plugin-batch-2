...
function PostView() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    fetch(academySettings.ajaxUrl + "?action=academy_settings_get_post_view").then(response => {
      return response.json();
    }).then(response => {
      if (response.success) {
...
function QRCode() {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
    children: "This this QRCode page"
  });
}
